		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#accenturetutorial4ui5tutorial4-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accenturetutorial4ui5tutorial4-display": {
								"semanticObject": "accenturetutorial4ui5tutorial4",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=accenture.tutorial4.ui5.tutorial4",
									"url": sap.ui.require.toUrl("accenture/tutorial4/ui5/tutorial4")
								}
							}
						}
					}
